    ...
    <footer className="bg-slate-900 text-slate-300 py-16 border-t border-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          ...
          <div className="space-y-6">
            <div className="flex items-center cursor-pointer" onClick={() => navigate('/')}>
              <span className="text-3xl font-extrabold bg-gradient-to-r from-blue-400 to-indigo-400 bg-clip-text text-transparent">
                Europass<span className="font-light text-slate-100">Builder</span>
              </span>
            </div>
            <p className="text-slate-400 text-sm leading-relaxed">
              Create professional, ATS-friendly resumes in minutes. Choose from our expert-designed templates and land your dream job faster.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#templates" className="hover:text-blue-400 transition-colors">Resume Templates</a></li>
              <li><a href="#features" className="hover:text-blue-400 transition-colors">Features</a></li>
              <li><a href="#" className="hover:text-blue-400 transition-colors">Cover Letters</a></li>
          ...
          <div>
            ...
            <ul className="space-y-4 text-sm">
              <li><a href="#" className="hover:text-blue-400 transition-colors">Resume Writing Guide</a></li>
          ...
          <div className="space-y-6">
            ...
            <ul className="space-y-4 text-sm">
              ...
              <li className="flex items-center space-x-3">
                ...
                <span>support@europassbuilder.com</span>
              </li>
            </ul>
          </div>
        </div>
        ...
        <div className="border-t border-slate-800 mt-16 pt-8 flex flex-col md:flex-row justify-between items-center text-xs text-slate-500">
          <p>&copy; {new Date().getFullYear()} EuropassBuilder. All rights reserved.</p>
